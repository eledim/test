...
var clsColorMap = {
    ...
    "牧师Priest":{
        color :"#e5e5e5",
        img:'<div class="GameIcon GameIcon--PRIEST GameIcon--vector GameIcon--tiny TalentCalculator-classIcon"><div class="GameIcon-icon"></div><div class="GameIcon-transmog"></div><div class="GameIcon-borderImage"></div></div>'},//FFFFFF
    "死亡骑士Death Knight":{
        color :"#C41F3B",
